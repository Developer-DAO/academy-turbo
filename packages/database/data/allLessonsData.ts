export const allLessonsData = [
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/oracles-api3/1-oracles-api3-pricefeeds",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/erc-20-solidity/2",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/intro-to-ethereum/2",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/intro-to-ethereum/3",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/nft-solidity/1",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/nft-solidity/2",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/nft-solidity/3",
  },
  {
  ...
  },
  {
    ...
    lessonTitle: "Building Multi Tiered NFTs: A User-Friendly Guide",
    authors: [],
    imgPath: "/track-erc721.png",
    lessonDescription:
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/nft-solidity/4",
  },
  {
    ...
    lessonPath: "/fundamentals/decentralized-storage",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 8,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/install-npm",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/erc-20-solidity/1",
  },
  {
    ...
    lessonPath: "/fundamentals/connect-with-rpc",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 4,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/decentralized-storage",
  },
  {
    ...
    lessonPath: "/fundamentals/code-editors",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 10,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/connect-with-rpc",
  },
  {
    ...
    lessonPath: "/fundamentals/nft-hosting",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 9,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/open_zeppelin",
  },
  {
    ...
    lessonPath: "/fundamentals/testnets",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 5,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/token-standards",
  },
  {
    ...
    lessonPath: "/fundamentals/wallets",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 3,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/intro-to-ethereum/1",
  },
  {
    ...
    imgPath: "/track-fundamentals.png",
    lessonDescription:
      "Whether you call your CLI a Linux terminal, Mac console, or Windows command prompt, you'll learn basic navigation, and essential commands to kickstart your development",
    lessonPath: "/fundamentals/cli_lesson",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 1,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/code-editors",
  },
  {
    ...
    lessonPath: "/fundamentals/install-npm",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 2,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/nft-hosting",
  },
  {
    ...
    lessonPath: "/fundamentals/open_zeppelin",
    trackId: "clrzj72mx00001wjojxz7d1gq",
    order: 6,
    productionVisible: true,
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/testnets",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/fundamentals/wallets",
  },
  {
    ...
    lessonTitle: "Smart Contracts: Automated Testing and Test-Driven Development",
    authors: [],
    imgPath: "/track-erc721.png",
    lessonDescription:
      "Learn Test Driven Development. A crucial skill for Solidity developers, a necessity in blockchain eco-systems. Your automated tests keep us safe.",
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/nft-solidity/5",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/oracles-api3/2-quantum-rand-num-gen",
  },
  {
    ...
    stagingVisible: true,
    visible: true,
    nextLessonPath: "/tracks/oracles-api3/3-airnode-deep-dive",
  },
  {
    id: "clskhhouu00012i92em3se6zv",
    projectLessonNumber: null,
    fundamentalLessonName: null,
    quizFileName: "web3-python/1",
    lessonTitle: "Python Smart Contract Development, Pt. 1",
    authors: [],
    imgPath: "/track-web3-python.png",
    lessonDescription:
      "Get a tour of Python smart contract tools, then deploy your first Vyper contract.",
    lessonPath: "/tracks/web3-python/1",
