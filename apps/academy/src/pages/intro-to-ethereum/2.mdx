...
<LessonLayout lessonTitle="A Developer's Guide to Ethereum, Pt. 2" lessonDescription="Introduction to Ethereum with web3.py and Python." >
...
<br />
{/* <QuizStatusChecker quiz="quiz-eth-intro-2" />s */}
