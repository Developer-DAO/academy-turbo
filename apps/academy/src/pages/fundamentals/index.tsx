...
bg-[url('/bg_fundamentals.png')] bg-cover bg-no-repeat object-center pt-[300px]  lg:fixed lg:inset-y-0 lg:h-screen lg:w-1/2"
      >
        <div>
          <h2 className="text-bttf text-5xl text-white lg:text-6xl">Fundamentals</h2>
        </div>
