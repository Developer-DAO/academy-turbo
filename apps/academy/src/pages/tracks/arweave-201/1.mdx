...
<Callout emoji="💡">
  Greetings reader! The Arweave 201 track assumes that you are comfortable with some basic knowledge
  about Arweave. This lesson is the same one that opens up the Arweave 101 track; If you are already
  familiar with this material, you can skip ahead to the next lesson in the Arweave 201 track.
</Callout>
