...
<QuizStatusChecker
  quiz="arweave-101/1"
  actionButton={{ href: "https://zealy.io/", text: "Claim Quest" }}
  successMessage={[
    {
    ...
    {
      message:
        "To claim your EXP tokens with AR.IO, share your success on Twitter, take a screenshot of this page and enter these alongwith your sceret code on Zealy.",
    },
    {
