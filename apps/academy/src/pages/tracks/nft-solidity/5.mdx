...
Try running `npm run dev` to see if everything is working as expected.
...
{/* TODO: Mention the various versions used. Mention here or above? */}
...
{/* TODO: Could remove the other default chains added in starter */}
...
default and its code should look like this after deleting all the _children_
...
{/* TODO: LET'S create functionality as a React component in it's own file */}

Let's create a new React component that will house our main application functionality
...
{/* TODO: Need to tell users what to replace CONTACT_ADDRESS with */}

Add the top import our new component.

```tsx
import { TierNFT } from "../components/tiernft";
```

Now add the component to the `index.tsx` file inbetween `<main></main>` tags.
...
<LessonInformationalModal buttonText="Code for default style" title="Code for default style">
