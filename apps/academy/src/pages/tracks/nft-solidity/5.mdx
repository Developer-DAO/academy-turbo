...
- Initialise a Next.js app
- Install RainbowKit and WAGMI to create main application
- Import dependencies
...
To get this setup we need to start working on the `page.js` file in the
`/frontend/src/app` directory. The file should look something like this from our
initial setup.
...
<LessonInformationalModal buttonText="Code so far for index.js" title="Code so far for index.js">
...
<LessonInformationalModal buttonText="Final Code for index.js" title="Final Code for index.js">
