...
<Callout emoji="💡">
All the code used in this lesson is included. We've intentionally pasted in complete code file
(instead of many snippets) to make it easier to keep track of where all the code goes.

Also here is a link to the fully working project at
...
transaction that matches our wallet address and ignore the otehrs. When the event we want comes in,
