...
<LessonLayoutLite
  ...
  headerSection={<div>
  <CreatedBy label="Updated in 2024 by:" author={"brianfive"} authorImage={"/authors/brianfive.jpg"} authorTwitter={"brianfive"} />
  <CreatedBy label="Created in 2022 by:" author={"ropats16"} authorImage={"/authors/ropats16.jpg"} authorTwitter={"ropats16"} />
  </div>}>
