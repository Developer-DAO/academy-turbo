...
#### `useMint` and `useAwaitMintResult` hooks
...
Let's add the `useAwaitMintResult` hook. Let's create a `hooks/useAwaitMintResult.ts` file and add the following code:
...
TODO: Explain the WAGMI hooks above and how they work.
