...
{/_ upgrades to descriptions are welcome. I/we might need to move the actual URLs down into
the tutorial if really needed. For now, they avoid that potential rabbit hole scenario while here _/}
...
{/_ We need more of an intro than the following 'The Main Application' as to what
...
{/_ add more explanations maybe explaining how they work together and why we need
it to perform better the UX _/}
...
{/_ if we can avoid the following link, that would be great. I think at a later stage
after this MVP, we can come back and create a few side-drawers for these hooks: _/}
