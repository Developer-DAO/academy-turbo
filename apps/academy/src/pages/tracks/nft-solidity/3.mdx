...
title: TierNFTs
description: Write and deploy a Smart Contract for a Tier Based NFT. Builds on knowledge
  from Lesson 2.
icons: ["npm", "solidity", "hardhat", "openzeppelin", "ethereum", "etherscan", "opensea", "polygon"]
---
...
<Callout emoji="💡">
  Also, make sure you have a line that says `.env` in the `.gitignore` file in your root folder. If
  this file doesn't exist, create it and add that line! This makes sure we don't accidentally upload
  our `.env` file to our public repositories by mistake.
</Callout>
...
<br />
<LessonQuestionsModal buttonText="Checkpoint Questions" title="Getting Our Tokens Out to the World">
...
we're looking forward to seeing you in our *Smart Contracts: Automated Testing and Test-Driven
Development (TDD)* project next!
