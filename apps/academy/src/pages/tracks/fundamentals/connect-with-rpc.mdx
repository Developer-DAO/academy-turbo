...
blockchain via _Zerion_ to Ethereum testnets such as _Ropsten_ and RPC
...
network, it can be accessed in the Zerion extension by clicking on the
...
A new network can be added in Zerion by clicking on the **Add a network**
