...
![create-apio.png](https://utfs.io/f/2sXGl0kj0PZB7eHIteSCKpkibIt9YBHFNTX1Q4oneqSfyuJ5)

First, create a Testnet API Key by selecting the Network as `TESTNET`:

![Name API](https://utfs.io/f/2sXGl0kj0PZBF50PjQD2BhtHCJ7vujfIwc6pLqTg2SrNoX4k)

After creating the API Key, click the API button to get your testnet RPC URL from the Connect API screen below:

![Connect API](https://utfs.io/f/2sXGl0kj0PZBm84Q7FAoEXToI1H7PjULgWwVO5N9ZaAq8GlS)
...
It should take about 30 seconds for the tRBTC to reach your wallet, and you'll see a confirmation like this with the transaction hash: ![confirmation.png](https://utfs.io/f/2sXGl0kj0PZBu72ENAOvpDGAsLPXcYeVg38ZfqTvOQ0jnW4b)
